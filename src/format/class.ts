...
export class Format {
     ...
     */
    readonly resolvedOptions: () => ResolvedFormatOptions;
     ...
     *   and interpretation of the locales argument, see the
     ...
     */
    constructor(locales?: Locale | Locale[], options?: FormatOptions) {
        options ??= {};
    ...
    static supportedLocales() {
        return Intl.NumberFormat.supportedLocalesOf(LOCALES.slice());
    }
     ...
     * @returns Array of strings with the available locales.
     */
    static supportedLocalesOf(locales: string | string[], options?: FormatOptions) {
